	...
	?>
        <div class="callout callout-danger">
          <p style="font-size:15px;text-align:center; color:red;">
            <i class="fa fa-warning"></i> <?php echo $this->session->flashdata('login_gagal'); ?>
          </p>
        </div>
        <?php
...
?>
 <div class="callout callout-danger">
          <p style="font-size:15px;text-align:center; color:green;">
            <i class="fa fa-check"></i> <?php echo $this->session->flashdata('message'); ?>
          </p>
        </div>
        <?php
} ?>
          <div class="wrap-input100 validate-input" data-validate = "NIK TIDAK TERDAFTAR!">
            <input class="input100" type="text" name="nikUsername">
            <span class="focus-input100" data-placeholder="NIK atau Username"></span>
          </div>
        ...
        <h6 class="text-center" style="padding-top: 25px;">Belum punya akun?</h6>
          <div class="container-login100-form-btn">
            <div class="wrap-login100-form-btn">
              <div class="login100-form-bgbtn"></div>
              <a class="btn-info login100-form-btn" name="Submit" alt="sign in" href="<?php echo base_url('Registrasi/index'); ?>">
                Register
              </a>
            </div>
          </div>
