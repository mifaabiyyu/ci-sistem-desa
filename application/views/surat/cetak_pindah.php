...
<table width="100%">
	<tr>
		<td width="50%"></td>
		<td width="50%"><center>Rejoso, <?php echo $pindah->tanggal_pindah; ?></center></td>
	</tr>
	<tr>
		<td></td>
		<td><center>Dikeluarkan oleh: <br />a.n. Kepala Dinas Kependudukan dan Pencatatan Sipil<br />Kepala Desa Rejoso</center></td>
	</tr>
	<tr>
		<td></td>
		<td></td>
