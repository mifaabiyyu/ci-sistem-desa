...
<br /><br /><br />
<font align="justify">
    Yang bertanda tangan dibawah ini , <?php echo $usaha->jabatan_pejabat; ?> Desa Rejoso Kecamatan Karawang Timur
...
<br>
<font align="justify">
    Menurut penelitian dan Pengantar RT setempat Nama/Orang tersebut benar Warga Desa Rejoso Kecamatan Karawang
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Rejoso, <?= date('d F Y', strtotime($usaha->tanggal_usaha)); ?></center>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <center>Kepala Desa Rejoso</center>
        </td>
    </tr>
    <tr>
        <td></td>
