...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $surat_kelahiran->jabatan_pejabat; ?> Desa Rejoso Kecamatan
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Rejoso, <?= date('d F Y', strtotime($surat_kelahiran->tanggal_surat_kelahiran)); ?> </center>
        </td>
    </tr>
    <tr>
        <td></td>
