                                ...
                                <form action="<?php echo base_url('surat/surat_kematian/tambah'); ?>" method="post">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <label>NIK Pelapor</label>
                                            ...
                                            <?php } else {  foreach($pendudukkk as $pndk) :?>
                                                <option value="<?php echo $pndk->nik; ?>">
                                                    <?php echo $pndk->nik; ?> - <?php echo $pndk->nama; ?>
                                                </option>
                                                <?php endforeach; }?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        <?php if($this->session->userdata('level') == 'penduduk') {?>
                                        <?php $date = new DateTime($pendudukkk->tanggal_lahir); 
                                            $today = new DateTime('today');
                                            $tahun = $today->diff($date)->y;?>
                                            <label>Umur Pelapor</label>
                                            <input type="number" name="umur" class="form-control"
                                                placeholder="Umur Pelapor" required value=<?php echo $tahun?> />
                                            <?php } else { ?>
                                                <label>Umur Pelapor</label>
                                            <input type="number" name="umur" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="pejabat" class="form-control" required>
                                                ...
                                                <option value="<?php echo $data_pejabat->id_pejabat; ?>">
                                                    <?php echo $data_pejabat->jabatan_pejabat; ?></option>
                                                <?php
                                                endforeach;
                                                ?>
                                            </select>
