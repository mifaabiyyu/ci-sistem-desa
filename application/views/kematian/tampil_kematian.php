                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                <a href="<?php echo base_url('Kematian/edit/' . $kematian->nik); ?>"
                                    class="btn btn-success btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                <a href="<?php echo base_url('Kematian/hapus/' . $kematian->nik); ?>"
                                    class="btn btn-danger btn-xs"
                                    onClick="return confirm('Yakin Akan Menghapus Data?');"><i
                                        class="fa fa-trash-o"></i> Hapus</a>
                                <a href="<?php echo base_url('Kematian/detail/' . $kematian->nik); ?>"
